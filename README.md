# Fitfinity Staff PWA Preview v0.12
...
## v0.12
Production UI cleanup: concise copy, consistent text-based Edit/Save/Cancel actions, all-exercise progress export, corrected Exercise Plan edit state, and camera controls pinned to the right of each exercise row.
